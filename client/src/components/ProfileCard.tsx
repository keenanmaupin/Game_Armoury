        ...
        <section className="col-12 col-md-6 col-lg-3 mb-4">
          <div className="card h-100" style={{ width: "30rem" }}>
            <img
              ...
              src={currentGame.background_image || "../assets/pexels-atomlaborblog-776092.jpg"}
            ...
            <div className="card-body">
              ...
              <div className="row">
                <div className="col-6">
                  ...
                  <p className="card-text mb-1">
                    <strong>Platforms:</strong> {currentGame.platforms?.length ? currentGame.platforms[0].platform.name : "N/A"}
                  </p>
                  <p className="card-text mb-1">
                    <strong>Released:</strong> {currentGame.released}
                  </p>
                  <p className="card-text mb-1">
                    <strong>Genre:</strong> {currentGame.genres?.length ? currentGame.genres[0]?.name : "N/A"}
                  </p>
                </div>
                <div className="col-6">
                  <p className="card-text mb-1">
